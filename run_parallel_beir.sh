#!/bin/bash
# ============================================================
# ReasonRank BEIR Benchmark Evaluation
# 16 BEIR datasets on 8 GPUs (data parallel)
#
# Usage:
#   MODEL=liuwenhan/reasonrank-7B bash run_parallel_beir.sh
#   MODEL=liuwenhan/reasonrank-32B bash run_parallel_beir.sh
# ============================================================
set -e
...
ALL_DATASETS=(
    scifact fiqa nfcorpus fever climate-fever
    hotpotqa nq quora dbpedia covid
    arguana touche scidocs news robust04 signal
)
NUM_DATASETS=${#ALL_DATASETS[@]}

echo "============================================"
echo "  ReasonRank BEIR Benchmark Evaluation"
echo "============================================"
echo "Model:          ${MODEL}"
...
echo "Datasets:       ${NUM_DATASETS} (BEIR)"
echo "============================================"
...
for ((i=0; i<NUM_INSTANCES; i++)); do
    ...
    CUDA_VISIBLE_DEVICES=${GPU_IDS} python run_rank_llm.py \
        ...
        ${WANDB_ENTITY_ARG} \
        --wandb_run_name "$(basename ${MODEL})_beir_gpu${GPU_IDS}" \
        --notes "B200 BEIR: GPU=${GPU_IDS} datasets=[${DATASETS_STR}]" \
        > "${LOG_FILE}" 2>&1 &
...
echo "============================================"
echo "  Collecting BEIR results into wandb"
echo "============================================"
...
echo "============================================"
echo "  BEIR evaluation done! Results in: results/"
echo "============================================"
