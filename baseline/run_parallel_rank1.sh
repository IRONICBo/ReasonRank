#!/bin/bash
# Rank1 Pointwise Reranker - Data Parallel on 8 GPUs
# Model: jhu-clsp/rank1-7b or jhu-clsp/rank1-32b
set -e
...
echo "============================================"
echo "  Rank1 Pointwise: ${MODEL_SHORT} on ${BENCHMARK}"
...
for ((i=0; i<TOTAL_GPUS; i++)); do
    ...
    CUDA_VISIBLE_DEVICES=${i} python baseline/run_rank1.py \
        --model_path ${MODEL} \
